!function () {
    ...
    var t = function () {
        return t = Object.assign || function (t) {
            for (var n, i = 1, s = arguments.length; i < s; i++) for (var a in n = arguments[i]) Object.prototype.hasOwnProperty.call(n, a) && (t[a] = n[a]);
            return t
        ...
        function n(n, i, s) {
            ...
            this.endVal = i, this.options = s, this.version = "2.3.2", this.defaults = {
                ...
                a.frameVal = i ? a.endVal : a.frameVal, a.frameVal = Number(a.frameVal.toFixed(a.options.decimalPlaces)), a.printValue(a.frameVal), n < a.duration ? a.rAF = requestAnimationFrame(a.count) : null !== a.finalEndVal ? a.update(a.finalEndVal) : a.callback && a.callback()
            }, this.formatNumber = function (t) {
                var n, i, s, e, r = t < 0 ? "-" : "";
                n = Math.abs(t).toFixed(a.options.decimalPlaces);
                var o = (n += "").split(".");
                if (i = o[0], s = o.length > 1 ? a.options.decimal + o[1] : "", a.options.useGrouping) {
                    e = "";
                    for (var l = 0, u = i.length; l < u; ++l) 0 !== l && l % 3 == 0 && (e = a.options.separator + e), e = i[u - l - 1] + e;
                    i = e
                }
                return a.options.numerals && a.options.numerals.length && (i = i.replace(/[0-9]/g, (function (t) {
                    ...
                    return a.options.numerals[+t]
                }))), r + a.options.prefix + i + s + a.options.suffix
        ...
        return n.prototype.handleScroll = function (t) {
            if (t && window && !t.once) {
                var n = window.innerHeight + window.scrollY, i = t.el.getBoundingClientRect(),
    ...
    !function () {
        const t = {
            counter() {
                const t = document.querySelectorAll(".bsb-fact-pro-5-counter");
                null != t && t.forEach((function (t) {
                    t.classList.contains("counter-initiated") || (new n(t, t.getAttribute("data-counter")).start(), t.classList.add("counter-initiated"))
                }))
            }, handleIntersect(n, i) {
                n.forEach((n => {
                    n.isIntersecting && t.counter()
                }))
            }, init() {
                const n = {root: null, rootMargin: "0px", threshold: [.5]},
                    i = document.querySelector("#bsb-fact-pro-5-observer");
